...
app.use('/api/v1/admin/education', require('./routes/api/v1/admin/educationAdmin.routes'));
...
app.use('/api/v1/education', require('./routes/api/v1/user/educationUser.routes'));
